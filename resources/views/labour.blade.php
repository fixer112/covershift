...
<head>
    ...
    <meta name="description"
        content="Book Online or contact us today for that Temporary shift cover: Event Assistants, Postroom & Facilities Assistants. London's best hands to cover staff absences">
            ...
            <div class="col-12 mx-auto">
                ...
                <div style="margin-bottom:30px">
                    <p style="color:blue;font-size:20px;font-weight: bold;">
                        We are your one-stop shop in London for flexible office & event porter services. All general
                        labour needs, ranging from
                        meeting room set up, moving furniture, load/unload of goods, help with office moves, facility
                        assistance, building
                        security & help with any Manual Handling tasks. We operate both on contract and per hour rates.
                    </p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 client" style="">
                        <img src="{{ asset('/labour1.jpg')}}" alt="security" style="width: 80%;">
                    </div>

                    <div class="col-6 client" style="">
                        <img src="{{ asset('/labour2.jpg')}}" alt="security" style="width: 80%;">
                    </div>
                    {{-- </div> --}}
                </div>

                <div class="plane-border col-12 mx-auto"
                    style="margin-bottom:30px;font-weight:bold;text-align:center;font-size:17px">
                ...
                <div class="col-10 mx-auto">
                    ...
                    <div class="half">
                        <h4 style="text-align: center;text-align: center;font-weight: bold;color: red;">CONTACT FORM
                        </h4>
                        <form class="form-horizontal" method="POST" action="/kec-mail">
                            ...
                            <div class="form-group{{ $errors->has('req') ? ' has-error' : '' }}">
                                ...
                                <div class="input">
                                    ...
                                    <textarea name="req" class="form-control" required
                                        autofocus>{{ old('req') }}</textarea>{{--
                                        <input type="text" class="form-control" name="request" value="{{ old('request') }}"required
                                    autofocus> --}}
                                </div>
                            </div>
                            ...
                            <input type="text" name="msg" value="New Client Applied To Flexible General Labour Services"
                                hidden>
