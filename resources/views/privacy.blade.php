...
<p style="text-align: center;">Privacy policy</p>
   <div class="detail" style="font-size: 10px">
   	...
   	<p>Information about your computer hardware and software may be automatically collected by CoverShift. This information may include: your IP address, browser type, domain names, access times and referring website addresses. This information is used for the operation of the platform, to maintain quality of the service, and to provide general statistics regarding use of covershift.co.uk</p>
   	...
   	<p>When CoverShift keep track of the websites and pages our users visit within covershift.co.uk it will be in order to determine what services is in ascendancy.</p>
   	...
   	<p>One of the primary purposes of cookies is to provide a convenience feature to save you time. The purpose of a cookie is to tell the Web server that you have returned to a specific page. For example, if you personalize our pages, or register with Covershift site or services, a cookie helps the system to recall specific information on subsequent visits. This simplifies the process of recording your personal information, such as billing addresses, shipping addresses, and so on. When you return to the same website, the information you previously provided can be retrieved, so you can easily use the features that you customized in covershift.co.uk</p>

   	<p>You have the ability to accept or decline cookies. Most Web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. If you choose to decline cookies, you may not be able to fully experience the interactive features of embedded in the CoverShift platform or websites you visit.</p>
